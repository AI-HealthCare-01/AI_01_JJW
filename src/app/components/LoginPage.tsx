    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl text-gray-900 mb-2">헬스케어 플랫폼</h1>
          <p className="text-gray-600">만성질환 예측 및 생활습관 개선 챌린지</p>
        </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-sm text-gray-900">AI 기반 만성질환 예측</h4>
                  <p className="text-sm text-gray-600">생활습관과 건강 데이터를 분석하여 질환 위험도를 예측합니다</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <Activity className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="text-sm text-gray-900">맞춤형 건강 대시보드</h4>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-sm text-gray-900">생활습관 개선 챌린지</h4>
                  <p className="text-sm text-gray-600">재미있는 챌린지를 통해 건강한 생활습관을 만들어가세요</p>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <p className="text-center text-xs text-gray-500 mt-6">
          로그인 시 <a href="#" className="underline">이용약관</a> 및 <a href="#" className="underline">개인정보처리방침</a>에 동의하는 것으로 간주됩니다
        </p>
      </div>
    </div>
  );
