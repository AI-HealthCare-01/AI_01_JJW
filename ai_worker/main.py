    ...
    async def process_health_prediction(self, task_id: str, data: Dict[str, Any]):
        ...
        try:
            ...
            task_response = TaskResponse(
                ...
                created_at=(await self.redis_client.hget(f"task:{task_id}", "created_at")),
        ...
        while True:
            try:
                ...
                if result:
                    ...
                    if task_data:
                        # 작업 처리
                        await self.process_health_prediction(task_id, json.loads(task_data.get("data", "{}")))
